...
namespace QuanLyShopBanGiay
{
    public static class DatabaseHelper
    {
        ...
        public static string AppConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=QuanLyShopGiay;Integrated Security=True;";
        ...
        public static void EnsureDatabase()
        {
            try
            {
                ...
                {
                    conn.Open();
                    using (var cmd = new SqlCommand("IF DB_ID('QuanLyShopGiay') IS NULL CREATE DATABASE [QuanLyShopGiay];", conn))
                    {
                        cmd.ExecuteNonQuery();
                    }
                }
...
END";
                    using (var cmd = new SqlCommand(insertProducts, conn))
                    {
                        cmd.ExecuteNonQuery();
                    }
                }
